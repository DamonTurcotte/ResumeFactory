...
export const TemplateView = ({ variant, profile, fonts, size, fontSize, margin, style }) => {
  ...
  const templateData = templateVariants[variant](profile, fonts, fontSize, margin, templateViewDimensions[size], categoryOrder, setCategoryOrder);
